...
const useCreateCategory = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (data: CategorySchemaType) => await createCategory(data),
    onSuccess: () => {
...
const useUpdateCategory = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (data: CategorySchemaType) => await updateCategory(data),
    onSuccess: () => {
